  ...
  return (
    <>
      <form
        ...
        className="flex justify-evenly flex-col items-center h-screen w-screen md:mt-[10%] md:mb-[10%]"
      >
        <div className="p-1 w-11/12 md:w-3/6  md:shadow-2xl md:border rounded-xl md:border-grey-50 md:py-10   h-[70%] md:h-fit  bg-gradient-to-b from-[#003DA5] to-[#023998]">
