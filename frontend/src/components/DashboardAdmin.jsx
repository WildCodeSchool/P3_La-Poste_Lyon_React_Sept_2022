  ...
  return (
    <div className="">
      ...
      <div className="mt-2 flex justify-center">
        <h1 className="flex justify-center items-center text-bold text-xl text-white rounded-xl shadow-lg bg-[#003DA5] w-2/3 h-10 text-center md:w-1/4 md:h-10 md:text-center">
          Mon tableau de bord
        </h1>
      </div>
